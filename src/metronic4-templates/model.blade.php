...
namespace Modules\{{$gen->moduleName}}\Models;
...
@endforeach
    ...
    {
        return $this->belongsTo('Modules\{{$gen->moduleName}}\Models\{{ucwords($fieldName)}}','{{$field->name}}');
    }

    public function set{{studly_case($fieldName)}}Attribute(${{$fieldName}}) {
